...
such as AirBnB price out the local, as landlords find it more profitable to rent 
...
In case of long-term rentals it may make more sense to look int rents per square
meter.
...
This map shows us similar "circle" pattern around the center, 
...
locals are much more agreeable with living not in the dead centre of the city.
...
in the area - they may just gravitate towards more expensive parts of the city.
...
From the regression we found that the ranking in median prices for Airbnbs change if the characteristics, amenities and type as well as the quality of its neighborhood of an Airbnb is taken account for in a model. It is not easy to represent the certainty in predictions in every visualization. Sometimes it can be more appropriate to have multiple visualizations that focus on different aspects side by side. None of the modeled causal effects alone leads to distinguishable distributions for price predictions but for the mean prices they do. Adding up multiple effects leads to noticeable shift. Figure \@ref(fig:multiple-contrasts) shows the contrast plot for two hypothetical Airbnbs that differ in half of their price influencing characteristics and amenities. Here the model is pretty sure about the outcome.
