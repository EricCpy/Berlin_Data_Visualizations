...
We can also try to compare the listings not with respect to the neighborhoods, 
but with respect to the other attributes, such as the price or the availability.
